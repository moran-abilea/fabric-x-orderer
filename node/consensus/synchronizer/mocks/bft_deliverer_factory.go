...
func (fake *BFTDelivererFactory) CreateBFTDelivererReturnsOnCall(i int, result1 synchronizer.BFTBlockDeliverer) {
	fake.createBFTDelivererMutex.Lock()
	defer fake.createBFTDelivererMutex.Unlock()
	fake.CreateBFTDelivererStub = nil
...
var _ synchronizer.BFTDelivererFactory = new(BFTDelivererFactory)

...
func (fake *FakePolicyManager) GetPolicy(arg1 string) (policies.Policy, bool) {
...
func (fake *FakePolicyManager) GetPolicyCallCount() int {
	fake.getPolicyMutex.RLock()
	defer fake.getPolicyMutex.RUnlock()
	return len(fake.getPolicyArgsForCall)
}

func (fake *FakePolicyManager) GetPolicyCalls(stub func(string) (policies.Policy, bool)) {
	fake.getPolicyMutex.Lock()
	defer fake.getPolicyMutex.Unlock()
	fake.GetPolicyStub = stub
}

func (fake *FakePolicyManager) GetPolicyArgsForCall(i int) string {
	fake.getPolicyMutex.RLock()
	defer fake.getPolicyMutex.RUnlock()
...
func (fake *FakePolicyManager) GetPolicyReturns(result1 policies.Policy, result2 bool) {
	fake.getPolicyMutex.Lock()
	defer fake.getPolicyMutex.Unlock()
...
func (fake *FakePolicyManager) GetPolicyReturnsOnCall(i int, result1 policies.Policy, result2 bool) {
	fake.getPolicyMutex.Lock()
	defer fake.getPolicyMutex.Unlock()
	fake.GetPolicyStub = nil
...
func (fake *FakePolicyManager) Manager(arg1 []string) (policies.Manager, bool) {
	var arg1Copy []string
	if arg1 != nil {
...
func (fake *FakePolicyManager) ManagerCallCount() int {
	fake.managerMutex.RLock()
	defer fake.managerMutex.RUnlock()
	return len(fake.managerArgsForCall)
}

func (fake *FakePolicyManager) ManagerCalls(stub func([]string) (policies.Manager, bool)) {
	fake.managerMutex.Lock()
	defer fake.managerMutex.Unlock()
	fake.ManagerStub = stub
}

func (fake *FakePolicyManager) ManagerArgsForCall(i int) []string {
	fake.managerMutex.RLock()
	defer fake.managerMutex.RUnlock()
...
func (fake *FakePolicyManager) ManagerReturns(result1 policies.Manager, result2 bool) {
	fake.managerMutex.Lock()
	defer fake.managerMutex.Unlock()
...
func (fake *FakePolicyManager) ManagerReturnsOnCall(i int, result1 policies.Manager, result2 bool) {
	fake.managerMutex.Lock()
	defer fake.managerMutex.Unlock()
	fake.ManagerStub = nil
...
func (fake *FakePolicyManager) Invocations() map[string][][]interface{} {
...
func (fake *FakePolicyManager) recordInvocation(key string, args []interface{}) {
